...
class Notebook:
    ...
    def modify_memo(self, note_id, memo):
        '''Find the note with give id and change its memo to the given value.'''
    ...
    def modify_tags(self, note_id, memo):
        '''Find the note with give note_id and change its tags to give value.'''
        for note in notes:
            if note.id == note_id:
                note.tags = tags
                break
